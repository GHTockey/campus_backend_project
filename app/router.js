...
module.exports = app => {
  ...
  router.delete('/api/home/swiper/:id', controller.home.delHomeSwiper); // 删除 home 轮播图
   router.post('/api/home/swiper/:id', controller.home.updHomeSwiper); // 修改 home 轮播图数据
  ...
  router.post('/api/home/article', checkAddArticleParams(), controller.home.addHomeArticle); // 新增主页文章
   router.post('/api/home/article/:id', checkAddArticleParams(), controller.home.updHomeArticle); // 修改主页文章
  ...
  router.delete('/api/hobby/swiper/:id', controller.hobby.delHobbySwiper); // 删除 hobby 轮播图
   router.post('/api/hobby/swiper/:id', controller.hobby.updHobbySwiper); // 修改 hobby 轮播图
  ...
  router.delete('/api/hobby/article/:id', controller.hobby.delHobbyArticle); // 删除兴趣圈文章
   router.post('/api/hobby/article/:id', checkAddArticleParams(), controller.hobby.updHobbyArticle); // 修改兴趣圈文章
  ...
  router.get('/api/hobby/cate', controller.hobby.getClassifyList); // 获取分类列表
   router.post('/api/hobby/cate/:id', controller.hobby.updClassify); // 修改分类
  ...
  router.delete('/api/socialize/article/:id', controller.socialize.delSocializeArticle); // 删除朋友圈文章
   router.post('/api/socialize/article/:id', checkAddArticleParams(), controller.socialize.updSocializeArticle); // 修改朋友圈文章
  ...
  router.get('/api/user/:id', controller.user.getUserInfo); // 获取用户信息
   ...
   router.post('/api/user/info/:id', controller.user.updUserInfo); // 修改用户信息
   router.post('/api/user/:id', controller.user.updUserData); // 修改用户数据
