...
module.exports = app => {
  ...
  router.post('/api/home/swiper/:id', controller.home.updHomeSwiper); // 修改 home 轮播图数据  (小程序不支持发起 patch 请求, 改为 post)
  ...
  router.post('/api/home/article/:id', controller.home.updHomeArticle); // 修改主页文章  (小程序不支持发起 patch 请求, 改为 post)
  ...
  router.post('/api/hobby/swiper/:id', controller.hobby.updHobbySwiper); // 修改 hobby 轮播图  (小程序不支持发起 patch 请求, 改为 post)
  ...
  router.post('/api/hobby/article/:id', controller.hobby.updHobbyArticle); // 修改兴趣圈文章  (小程序不支持发起 patch 请求, 改为 post)
  ...
  router.post('/api/hobby/cate/:id', controller.hobby.updClassify); // 修改分类  (小程序不支持发起 patch 请求, 改为 post)
  ...
  router.post('/api/socialize/article/:id', controller.socialize.updSocializeArticle); // 修改朋友圈文章  (小程序不支持发起 patch 请求, 改为 post)
